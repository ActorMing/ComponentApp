 ...
 * date   : 2018/8/15/015
 * desc   : 通过修改系统参数来适配android设备
 * 开始使用之前需要将文中 'TODO' 部分进行替换
 * 替换的地方{@link #setAppOrientation(Activity, String)}
 * update :
 * address:
 * <p> github https://github.com/raul-lsj/ScreenDensityUtils
 * csdn  : https://blog.csdn.net/raul575_li/article/details/80801312</p>
 */
public class DensityUtils {
    ...
    /**
     * 此方法在BaseActivity中做初始化(如果不封装BaseActivity的话,直接用下面那个方法就好{@link #setOrientation(Activity, String)})
    ...
    private static void setAppOrientation(@Nullable Activity activity, String orientation) {
        ...
        if (orientation.equals(HEIGHT)) {
            // 设计图的高度 单位:dp
            // TODO: 2018/8/15/015 Replace the height of your designs
            targetDensity = (appDisplayMetrics.heightPixels - barHeight) / 667f;
        } else {
            // 设计图的宽度 单位:dp
            // TODO: 2018/8/15/015 Replace the width of your designs
