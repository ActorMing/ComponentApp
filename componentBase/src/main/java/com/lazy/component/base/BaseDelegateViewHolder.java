...
public class BaseDelegateViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return The BaseDelegateViewHolder for chaining.
     */
     ...
     */
    @Deprecated
    public BaseDelegateViewHolder setOnClickListener(@IdRes int viewId, View.OnClickListener listener) {
        View view = getView(viewId);
    ...
    public BaseDelegateViewHolder addOnClickListener(@IdRes final int viewId) {
     ...
     * @return
     */
    public BaseDelegateViewHolder setNestView(@IdRes int viewId) {
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseDelegateViewHolder addOnLongClickListener(@IdRes final int viewId) {
     ...
     */
    @Deprecated
    public BaseDelegateViewHolder setOnTouchListener(@IdRes int viewId, View.OnTouchListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseDelegateViewHolder setOnLongClickListener(@IdRes int viewId, View.OnLongClickListener listener) {
        View view = getView(viewId);
     ...
     */
    @Deprecated
    public BaseDelegateViewHolder setOnItemClickListener(@IdRes int viewId, AdapterView.OnItemClickListener listener) {
     ...
     * @return The BaseDelegateViewHolder for chaining.
     */
    public BaseDelegateViewHolder setOnItemLongClickListener(@IdRes int viewId, AdapterView.OnItemLongClickListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseDelegateViewHolder for chaining.
     */
    public BaseDelegateViewHolder setOnItemSelectedClickListener(@IdRes int viewId, AdapterView.OnItemSelectedListener listener) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseDelegateViewHolder for chaining.
     */
    public BaseDelegateViewHolder setOnCheckedChangeListener(@IdRes int viewId, CompoundButton.OnCheckedChangeListener listener) {
     ...
     */
    @SuppressWarnings("unchecked")
    public BaseDelegateViewHolder setAdapter(@IdRes int viewId, Adapter adapter) {
        AdapterView view = getView(viewId);
     ...
     * @return The BaseDelegateViewHolder for chaining.
     */
    protected BaseDelegateViewHolder setAdapter(BaseDelegateAdapter adapter) {
